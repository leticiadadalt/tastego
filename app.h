...
public:
    ...
    void setDBHostName(string DBHostName);
    string getDBName();
    ...
    void menuBusca();
    void buscaComFiltros();
    void buscaTituloParcial();
    ...
    //funcoes auxiliares
    int encontrarUsuarioPorId(int idUsuario);
    int encontrarPaisPorId(int idPais);
    int encontrarReceitaPorId(int idReceita);
    vector<int> encontrarReceitasPorNomeAproximado(string pesquisa);
