...
Atributos:
 ...
 - idUsuario: id do usuario no banco de dados
 - favoritos: vetor de objetos da classe favorito, contendo informacoes de receitas favoritadas. 
*/
...
public:
    ...
    void removerFavorito(int posicao);
